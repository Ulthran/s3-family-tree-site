...
FamilyTree.templates.myTemplate.img_0 =
    ...
    + '</image>';
FamilyTree.templates.myTemplate.field_0 = '<text style="font-size: 14px;" fill="#ffffff" x="100" y="90" text-anchor="middle">{val}</text>';
FamilyTree.templates.myTemplate.field_1 = '<text style="font-size: 24px;" fill="#ffffff" x="100" y="60" text-anchor="middle">{val}</text>';
FamilyTree.templates.myTemplate.field_3 = '<text style="font-size: 12px;" fill="#eeeeee" x="35" y="120" text-anchor="middle">{val}</text>';
FamilyTree.templates.myTemplate.field_4 = '<text style="font-size: 12px;" fill="#eeeeee" x="165" y="120" text-anchor="middle">{val}</text>';
...
FamilyTree.templates.myTemplate_female.node = '<circle cx="100" cy="100" r="100" fill="#039be5" stroke-width="1" stroke="#aeaeae"></circle>';
